...
export function StudentSection({ certificatesStatus, specialization, resume, onUpdate }: StudentSectionProps) {
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                onUpdate(certificatesStatus || "", specialization || "", data.url);
    ...
    const handleRemoveResume = () => {
        onUpdate(certificatesStatus || "", specialization || "", "");
            ...
            <CardContent className="space-y-6">
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onValueChange={(value) => onUpdate(value, specialization || "", resume)}
                    >
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) => onUpdate(certificatesStatus || "", e.target.value, resume)}
