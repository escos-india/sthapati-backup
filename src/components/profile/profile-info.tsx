...
export function ProfileInfo({ name, headline, location, image, onImageChange, onSave }: ProfileInfoProps) {
    ...
    const isSaveDisabled = !editHeadline || !editLocation.country || !editLocation.city;
        ...
        <div className="bg-white dark:bg-gray-800 rounded-b-lg shadow-sm border-x border-b border-slate-200 dark:border-slate-800 p-6 relative group">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 space-y-1 text-center md:text-left">
                    ...
                    {isEditing ? (
                        <div className="space-y-4 max-w-xl animate-in fade-in slide-in-from-top-1">
                        ...
                        <>
                            <p className="text-lg text-slate-700 dark:text-slate-300">{headline || "Add a headline..."}</p>
