        ...
        >
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
            {user.projects.map((project: any, idx: number) => (
              <Card key={idx} className="min-w-[280px] rounded-2xl border border-slate-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer group">
              ...
              <Card className="rounded-3xl border border-slate-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl shadow-lg overflow-hidden transition-colors duration-300">
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between">
                    ...
                    {!readOnly && user._id === post.author._id && (
                      <DropdownMenu>
